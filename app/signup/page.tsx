...
export default function SignUp() {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    console.log("submitted....not sure");
  };
  ...
  return (
    ...
    >
      ...
      <section className="login_section relative bg-opacity-20 flex flex-col space-y-20 justify-center items-center w-[60%]  lg:w-[50%]">
        {isloading ? (
          <>
            <h1>Loading...</h1>
