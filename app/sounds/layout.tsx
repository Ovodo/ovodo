...
export default function SoundLayout({ children }: SoundLayoutProps) {
      ...
      <div className="navFrame pt-5 pl-4 bg-slate-400">
        <div className="mb-10 space-y-2">
          <Link
            ...
            className={pathname === "/sounds" ? "utility" : "navlink"}
          >
            Samplepacks
          </Link>
          ...
          <Link
            ...
            className={pathname === "/sounds/songs" ? "utility" : "navlink"}
          >
            Songs
          </Link>
          ...
          <Link
            ...
            className={pathname === "/sounds/beats" ? "utility" : "navlink"}
          >
            Beats
          </Link>
          ...
          <Link
            ...
            className={pathname === "/sounds/presets" ? "utility" : "navlink"}
          >
            Presets
          </Link>
        </div>
