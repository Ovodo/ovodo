...
const ProjectsCard = ({
  ...
  return (
    <Link
      href={href}
      className="text-primary border-b bord  cursor-pointer  hover:card hover:border-b-8 duration-300 hover:border-10  min-w-[362px] h-[220px]  sm:h-[268px] flex gap-2 md:gap-4 flex-col"
    >
